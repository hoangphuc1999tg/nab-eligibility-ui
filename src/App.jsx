    ...
    <IPhoneMockup>
      ...
      <div className="px-6 pb-28 pt-6">
        <div className="text-center">
          ...
          <p className="mt-4 text-sm text-slate-500">Check your eligibility</p>
          ...
          <p className="mx-auto mt-2 max-w-[260px] text-sm leading-6 text-slate-600">
            Enter your National ID to check eligibility in a few seconds.
          </p>
        </div>
        ...
        <div className="mt-6 border-t border-slate-100 pt-4">
          ...
          <p className="mt-1 text-sm text-slate-700">
            Age, Vietnam address, criminal record and credit score.
          </p>
        </div>
      </div>
